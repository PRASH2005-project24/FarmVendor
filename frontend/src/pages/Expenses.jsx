...
export default function Expenses() {
  ...
  const fetchData = () => {
    Promise.all([API.get('/expenses'), API.get('/land')])
                  ...
                  <tbody>
                    {expenses.map(e => (
                      <tr key={e.expense_id}>
                        ...
                        <td><button className="btn btn-danger" onClick={() => handleDelete(e.expense_id)}><FiTrash2 /> {t('delete')}</button></td>
                      </tr>
                    ))}
                  </tbody>
                </table>
              ...
              <div className="mobile-cards">
                {expenses.map(e => (
                  <div key={e.expense_id} className="mobile-card">
                    ...
                    <div className="mobile-card-actions"><button className="btn btn-danger" onClick={() => handleDelete(e.expense_id)}><FiTrash2 /> {t('delete')}</button></div>
                  </div>
                ))}
              </div>
            </>
